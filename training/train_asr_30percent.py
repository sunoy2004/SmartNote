...
Trains on 30% of LibriSpeech dataset
...
def main():
    parser = argparse.ArgumentParser(description='Train Custom ASR Model on 30% of Dataset')
    parser.add_argument('--epochs', type=int, default=20, help='Number of epochs')
    parser.add_argument('--batch_size', type=int, default=8, help='Batch size')
    parser.add_argument('--lr', type=float, default=0.001, help='Learning rate')
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints/asr_30percent', help='Checkpoint directory')
    ...
    # Data loaders - using 30% of the dataset
    print("Loading data (30% of dataset)...")
    ...
    print("\nStarting training on 30% of dataset...")
