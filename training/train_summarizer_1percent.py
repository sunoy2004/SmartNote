...
Trains on 1% of LibriSpeech dataset
...
def main():
    parser = argparse.ArgumentParser(description='Train Custom Summarization Model on 1% of Dataset')
    parser.add_argument('--epochs', type=int, default=15, help='Number of epochs')
    parser.add_argument('--batch_size', type=int, default=16, help='Batch size')
    parser.add_argument('--lr', type=float, default=0.0001, help='Learning rate')
    parser.add_argument('--checkpoint_dir', type=str, default='checkpoints/summarizer_1percent', help='Checkpoint directory')
    ...
    # Data loaders - using 1% of the dataset
    print("Loading data (1% of dataset)...")
    train_loader, val_loader, test_loader, tokenizer = get_summarization_dataloaders(
        ...
        subset_percent=1  # 1% of the dataset
    )
    ...
    print("\nStarting training on 1% of dataset...")
